...
You ask Claude "find me the BibTeX for that mutation testing paper" and it searches your Zotero library, finds the item, and returns the citation — in under a millisecond. No plugins needed, Zotero does not even need to be running. The server reads your local Zotero database directly and exposes 25 tools: search, browse, cite, export, organize, and resolve PDFs from 9 academic sources.
